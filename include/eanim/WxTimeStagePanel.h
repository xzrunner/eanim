...
{
public:
	WxTimeStagePanel(wxWindow* parent, const ee0::SubjectMgrPtr& sub_mgr,
...
private:
	...
	static eanim::LanguageEntry entries[];

private:
	ee0::SubjectMgrPtr m_sub_mgr;

	const anim::PlayCtrl& m_pctrl;

	eanim::TimeStageEdit m_editop;
